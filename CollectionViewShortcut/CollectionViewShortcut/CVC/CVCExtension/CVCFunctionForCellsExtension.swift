//
//  CVCFunctionForCellsExtension.swift
...
extension CollectionViewController {
    ...
    func roundCorner(cell: CollectionViewCell) {
        cell.contentView.layer.masksToBounds = true
        cell.contentView.layer.cornerRadius = 12.0
    }
    
    func setCellShadow(cell: CollectionViewCell) {
    ...
    func gradientBackgroundColor(cell: CollectionViewCell, colors: [UIColor]) {
        // let colors = cellRandomBackgroundColors()
        cell.contentView.setGradientBackgroundColor(colorOne: colors[0], colorTow: colors[1])
    }
    
    // nao esta a ser usado agora
